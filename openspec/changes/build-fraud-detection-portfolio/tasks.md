...
- [x] 10.6 Registrar o projeto no site (entrada + redeploy do portfólio pelo processo do `DEPLOY.md` dele) **somente com a confirmação do dono**; verificar que o card aparece em `/projects` com o link da demo
- [x] 10.7 Atualizar a página do Notion "Real-Time Fraud Detection System" (status → Concluído, link da demo/repo) **somente com a confirmação do dono**; verificar a propriedade Status na base "Lista"
